...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <title>Admin Bienestar</title>

		<link rel="stylesheet" href="/assets_admin/plugins/morris/morris.css">
        <link href="/assets_admin/plugins/switchery/switchery.min.css" rel="stylesheet" />
    ...
    <body class="fixed-left">
                    ...
                    <ul class="list-inline float-right mb-0">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-arrow-success dropdown-lg" aria-labelledby="Preview">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon bg-faded">
                                        <img src="/assets_admin/images/users/avatar-2.jpg" alt="img" class="rounded-circle img-fluid">
                                    </div>
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon bg-faded">
                                        <img src="/assets_admin/images/users/avatar-3.jpg" alt="img" class="rounded-circle img-fluid">
                                    </div>
                                    <p class="notify-details">
                                        <b>Carlos Crouch</b>
                                        <span>New tasks needs to be done</span>
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon bg-faded">
                                        <img src="/assets_admin/images/users/avatar-4.jpg" alt="img" class="rounded-circle img-fluid">
                                    </div>
                                    <p class="notify-details">
                                        <b>Robert Taylor</b>
                                        <span>New tasks needs to be done</span>
                        ...
                        <li class="list-inline-item dropdown notification-list">
                            <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                               aria-haspopup="false" aria-expanded="false">
                                <img src="/assets_admin/images/users/avatar-1.jpg" alt="user" class="rounded-circle">
                            </a>
        ...
        <script src="/assets_admin/js/popper.min.js"></script><!-- Tether for Bootstrap -->
        <script src="/assets_admin/js/bootstrap.min.js"></script>
        <script src="/assets_admin/js/detect.js"></script>
        <script src="/assets_admin/js/fastclick.js"></script>
        <script src="/assets_admin/js/jquery.blockUI.js"></script>
        ...
        <script src="/assets_admin/js/jquery.slimscroll.js"></script>
        ...
        <script src="/assets_admin/plugins/waypoints/lib/jquery.waypoints.min.js"></script>
        <script src="/assets_admin/plugins/counterup/jquery.counterup.min.js"></script>

        <script src="/assets_admin/js/jquery.core.js"></script>
        <script src="/assets_admin/js/jquery.app.js"></script>

        <script src="/assets_admin/pages/jquery.dashboard.js"></script>
